...
<table width="100%">
    <tr>
        <th>
            <h3><table>
                ...
                <tr>
                    <td>Ul. ${selectedBuilding.street} ${selectedBuilding.buildingNumber} / ${selectedFlat.flatNumber}</td>
                </tr>
                <tr>
    ...
    <tr>
        <td>
            <form:form method="post" action="inFlatAddCharges.html" modelAttribute="addCharges">
                <form:hidden path="id" modelAttribute="selectedFlat"/>
            <table>
                <tr>
            ...
            <div class="form-group">
                ...
                <table class="table table-hover" >
                    ...
                    <c:forEach items="${locators}" var="zaUser">
                        ...
                        <c:forEach items="${locatorsFlat}" var="locFlat">

                            ${zaUser.id == locFlat.id ? 'checked' : ''}
